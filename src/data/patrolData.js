...
export const patrolBuildings = buildings.map(b => {
  const freqMap = { "스타빌": 1, "다존하우스": 1, "미래홈": 1, "한스텔": 1, "모던라이프": 1, "에덴빌": 1, "토브미하우스": 1, "풍림빌딩": 1, "신림프리미어": 1, "아페이론": 1, "제이앤제이": 1, "포유빌": 1, "굿모닝빌": 1, "W하우스": 1, "모닝빌": 1, "지앤지2": 1, "서연빌": 1, "어반그레이": 1 };
  ...
  const doneMap = {
    "스타빌": { dates: ["2026-02-15"], status: "정상" },
    "다존하우스": { dates: ["2026-02-15"], status: "정상" },
    "미래홈": { dates: ["2026-02-15"], status: "정상" },
    "한스텔": { dates: ["2026-02-15"], status: "정상" },
    "모던라이프": { dates: ["2026-02-15"], status: "정상" },
    "신림프리미어": { dates: ["2026-02-15"], status: "정상" },
    "아페이론": { dates: ["2026-02-15"], status: "정상" },
    "제이앤제이": { dates: ["2026-02-15"], status: "정상" },
    "포유빌": { dates: ["2026-02-15"], status: "정상" },
    "굿모닝빌": { dates: ["2026-02-15"], status: "정상" },
    "W하우스": { dates: ["2026-02-15"], status: "정상" },
    "모닝빌": { dates: ["2026-02-15"], status: "정상" },
    "지앤지2": { dates: ["2026-02-15"], status: "정상" },
    "와이원빈티지": { dates: ["2026-02-15"], status: "정상" },
    "모던하우스": { dates: ["2026-02-15"], status: "정상" },
    "리트코하우스": { dates: ["2026-02-15"], status: "정상" },
    "에덴빌": { dates: ["2026-02-15"], status: "정상" },
    "토브미하우스": { dates: ["2026-02-15"], status: "정상" },
    "풍림빌딩": { dates: ["2026-02-15"], status: "정상" },
    "서연빌": { dates: ["2026-02-15"], status: "정상" },
    "어반그레이": { dates: ["2026-02-15"], status: "정상" },
  };
