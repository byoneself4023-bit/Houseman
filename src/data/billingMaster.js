...
export const settlementMaster = {
  // ── A. 월세 퍼센트형 (HM계좌) ──
  "제이앤제이": { type: "A", feeType: "pct", feeRate: 0, direction: "hm_to_owner", settlementDay: 15, periodType: "mid", vat: false, address: "서울 관악구 제이앤제이빌라", ownerName: "박시현", notes: "자가건물(박시현 소유). 수수료 없음. 누나 계좌로 정산." },
