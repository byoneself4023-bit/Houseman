import type { PastTenant } from '../types';
export const pastTenants: Record<string, PastTenant[]> = {
  ...
  스타빌_301_2: [
    {
      ...
      waterReading: 5000,
      damageFee: 50000,
      damageDesc: '벽면 훼손 (입주사진 대비)',
      // 위약금: 7일치 월세+관리비 = (700000+80000)/31*7 ≈ 175,806
      penalty7: 175806,
      penaltyReason: '조기퇴실 (만기 03-15, 퇴실 03-10)',
      // 예치금 반환
