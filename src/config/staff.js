...
export const staffRoles = [
  ...
  { id: "marketing", label: "마케팅팀", icon: "📣", color: "#8B5CF6", desc: "마케팅·홍보 담당" },
...
export const initialStaffMembers = [
  ...
  { id: 7, name: "이진아", phone: "010-7890-1234", pw: "1234", roles: ["internal"], assignedBuildings: [] },
  { id: 8, name: "조현경", phone: "010-8901-2345", pw: "1234", roles: ["internal"], assignedBuildings: [] },
];
