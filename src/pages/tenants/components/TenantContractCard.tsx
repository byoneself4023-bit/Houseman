          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <span className="text-[16px] font-bold text-hm-text">{pc.building} {pc.room}호</span>
                <span className="text-xs font-bold px-1.5 py-0.5 rounded bg-emerald-100 text-emerald-800">계약서 입력</span>
                <span className={`text-xs font-bold px-1.5 py-0.5 rounded ${isDangi ? 'bg-hm-warning-bg text-hm-warning' : 'bg-hm-blue-bg text-hm-blue-dark'}`}>{roomType}</span>
              </div>
              <div className="text-xs text-hm-success mt-0.5">입퇴실일정에서 전달된 계약 정보 · 등록자: {pc.registeredBy || "\u2014"} · {pc.registeredAt || "\u2014"}</div>
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2 pb-1.5 border-b-[1.5px] border-hm-border">
              ...
              <div className="flex items-center gap-3">
                ...
                <label className={`flex items-center gap-1 cursor-pointer text-xs ${hasParking ? 'text-hm-danger font-bold' : 'text-hm-text-sub font-normal'}`}>
            ...
            <div className="flex gap-2">
              ...
              <button onClick={() => {
                ...
                className="flex-[2] py-3 rounded-lg border-none bg-hm-success text-white font-bold text-sm cursor-pointer font-[inherit] hover:brightness-110 transition-all">🏠 호실등록</button>
            </div>
          </div>
        </div>
      </Card>
