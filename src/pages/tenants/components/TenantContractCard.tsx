        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2 mb-3 p-2.5 bg-hm-danger-bg rounded-[10px] border-[1.5px] border-hm-danger-border">
              <div><div className="text-[9px] text-hm-danger font-bold mb-0.5">입주자명 <span className="text-hm-danger">*</span></div><input id="pc-name" placeholder="이름 입력" className={inputClassName} style={{ padding: "7px 10px", fontSize: 12, borderColor: "var(--color-hm-danger-border)" }} /></div>
              <div><div className="text-[9px] text-hm-danger font-bold mb-0.5">연락처1 <span className="text-hm-danger">*</span></div><input id="pc-phone" placeholder="010-0000-0000" className={inputClassName} style={{ padding: "7px 10px", fontSize: 12, borderColor: "var(--color-hm-danger-border)" }} /></div>
              <div><div className="text-[9px] text-hm-danger font-bold mb-0.5">주민등록번호 <span className="text-hm-danger">*</span></div><input id="pc-ssn" placeholder="000000-0000000" className={`${inputClassName} font-mono`} style={{ padding: "7px 10px", fontSize: 12, borderColor: "var(--color-hm-danger-border)" }} /></div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 mb-2">
              <div><div className="text-[9px] mb-0.5" style={{ color: pc.moveIn || pc.date ? "var(--color-hm-text-muted)" : "var(--color-hm-danger)", fontWeight: pc.moveIn || pc.date ? 400 : 700 }}>입주일 {!(pc.moveIn || pc.date) && <span className="text-hm-danger">*</span>}</div><input id="pc-movein" type="date" defaultValue={pc.moveIn || pc.date} className={inputClassName} style={{ padding: "7px 10px", fontSize: 12, borderColor: pc.moveIn || pc.date ? undefined : "var(--color-hm-danger-border)" }} /></div>
              <div><div className="text-[9px] mb-0.5" style={{ color: pc.expiry ? "var(--color-hm-text-muted)" : "var(--color-hm-danger)", fontWeight: pc.expiry ? 400 : 700 }}>만기일 {!pc.expiry && <span className="text-hm-danger">*</span>}</div><input id="pc-expiry" type="date" defaultValue={pc.expiry || ""} className={inputClassName} style={{ padding: "7px 10px", fontSize: 12, borderColor: pc.expiry ? undefined : "var(--color-hm-danger-border)" }} /></div>
            ...
            <div className="grid grid-cols-3 gap-2 mb-2">
              <div><div className="text-[9px] mb-0.5" style={{ color: pc.deposit ? "var(--color-hm-text-muted)" : "var(--color-hm-danger)", fontWeight: pc.deposit ? 400 : 700 }}>{pcDepositLabel} (만원) {!pc.deposit && <span className="text-hm-danger">*</span>}</div><input id="pc-deposit" defaultValue={pc.deposit || ""} className={`${inputClassName} text-right`} style={{ padding: "7px 10px", fontSize: 12, borderColor: pc.deposit ? undefined : "var(--color-hm-danger-border)" }} /></div>
              <div>
                <div className="flex items-center justify-between mb-0.5">
                  <span className="text-[9px]" style={{ color: pc.rent ? "var(--color-hm-text-muted)" : "var(--color-hm-danger)", fontWeight: pc.rent ? 400 : 700 }}>임대료 (만원) {!pc.rent && <span className="text-hm-danger">*</span>}</span>
